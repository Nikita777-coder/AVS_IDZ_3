...
.L3:
	...
	mov	r12d, eax                       # int index = eax (предыдущую и эту строчки можно оптимизировать)
...
.L9:
	...
	jmp	.L8
.L7:
	cmp	r12d, 2           # index == 2 (-44[rbp] = index можно оптимизировать)
	jne	.L8
	mov	eax, r12d
	cdqe
...
.L17:
	...
	movsd	xmm1, QWORD PTR -96[rbp]    # xmm1 = b
	movsd	xmm0, QWORD PTR -88[rbp]    # xmm0 = a
	mov	rdi, QWORD PTR F@GOTPCREL[rip]  # вызов функции F
	call	FindRoot@PLT
